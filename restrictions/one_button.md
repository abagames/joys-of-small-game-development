...
ゲームジャムにおけるインタラクトへの制約において、プレイヤーが使える操作をただ 1 つのボタンに限るという、いわゆるワンボタンゲームのゲームジャムもある。ここで言うワンボタンゲームは、レバーによる移動の他のボタンが 1 つ、といったものではなくて、純粋に 1 つのボタンしか操作に使わないゲームを指す。
